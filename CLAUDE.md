...
Hard rules: nothing company-specific in the repo (no internal hostnames, proxy
URLs, employer names, customer or meeting names, personal emails); no code
comments by default; no lint exemptions - fix the code or rename.
